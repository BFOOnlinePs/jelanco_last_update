...
class InsuranceCompaniesController extends Controller
{
    ...
    {
        $data = User::where('user_role', 8)->get();
    ...
    public function add()
    {
        ...
        return view('admin.users.insurance_companies.add',['user_category'=>$user_category]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.users.insurance_companies.edit', ['data' => $data,'user_category'=>$user_category]);
    }
