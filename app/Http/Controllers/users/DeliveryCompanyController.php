...
class DeliveryCompanyController extends Controller
{
    ...
    {
        $data = User::where('user_role', 5)->get();
    ...
    public function add()
    {
        ...
        return view('admin.users.delivery_company.add',['user_category'=>$user_category]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.users.delivery_company.edit', ['data' => $data,'user_category'=>$user_category]);
    }
