...
class StorekeeperController extends Controller
{
    public function index(){
        $data = User::where('user_role',9)->get();
        return view('admin.users.storekeeper.index',['data'=>$data]);
    }

    public function add(){
        $user_category = UserCategoryModel::get();
        return view('admin.users.storekeeper.add',['user_category'=>$user_category]);
    }
...
//        $data->user_iban_number = $request->user_iban_number;
    ...
    public function edit($id){
        ...
        $user_category = UserCategoryModel::get();
        return view('admin.users.storekeeper.edit',['data'=>$data,'user_category'=>$user_category,'user_category'=>$user_category]);
    }
...
//        }
    ...
    public function shipping_details($order_id){
        ...
        return view('admin.orders.storekeeper.shipping_info',['data'=>$data]);
    }
