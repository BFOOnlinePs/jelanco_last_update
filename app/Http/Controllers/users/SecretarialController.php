...
class SecretarialController extends Controller
{
    public function index(){
        $data = User::where('user_role',3)->get();
        return view('admin.users.secretarial.index',['data'=>$data]);
    }

    public function add(){
        $user_category = UserCategoryModel::get();
        return view('admin.users.secretarial.add',['user_category'=>$user_category]);
    }
...
//        $data->user_iban_number = $request->user_iban_number;
    ...
    public function edit($id){
        ...
        $user_category = UserCategoryModel::get();
        return view('admin.users.secretarial.edit',['data'=>$data,'user_category'=>$user_category]);
    }
