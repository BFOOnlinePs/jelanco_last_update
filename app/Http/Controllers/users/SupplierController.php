...
class SupplierController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        $data->potential_suppliers = $request->has('potential_suppliers') ? 'certified' : 'not_supported';
        if ($data->save()) {
    ...
    public function updatePotentialStatus(Request $request)
    {
        ...
        $user->potential_suppliers = ($user->potential_suppliers == 'certified') ? 'not_supported' : 'certified';
        $user->save();
