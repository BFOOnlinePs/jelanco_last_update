...
@section('content')
    ...
    <button type="button" class="btn btn-dark mb-2" data-toggle="modal" data-target="#modal-default">اضافة تصنيف
    </button>
    <div class="card">

        <div class="card-header">
            <h3 class="text-center">قائمة التصنيفات</h3>
        </div>
                            ...
                            @else
                                @foreach ($data as $key)
                                    <tr>
                                        <td>{{ $key->name }}</td>
                                        <td>
                                            <a href="{{ route('setting.user_category.edit',['id'=>$key->id]) }}" class="btn btn-success btn-sm"><span
                ...
                <div class="modal-content">
                    <form action="">
                        <div class="modal-header">
                            <h4 class="modal-title">اضافة مجال اختصاص</h4>
