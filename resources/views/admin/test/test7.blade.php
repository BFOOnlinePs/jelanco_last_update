...
{{--                        <a class="btn btn-warning d-block m-2">حالة الطلبات</a>--}}
                    ...
                    <div class="col border border-black ml-3">
                        <div class="border-top-0">
                            <div class="m-2">
                                <h4 class="text-center">قائمة طرق الدفع</h4>
                                <a href="" class="mb-2 btn btn-sm btn-primary">اضافة طريقة للدفع</a>
                                <div class="row">
                                    <div class="col">
                                        <table class="table table-striped">
                                            <thead>
                                            <tr>
                                                <th>رقم طريقة الدفع</th>
...
{{--                                            </div>--}}
{{--                                            <div class="form-group">--}}
{{--                                                <label for="">نبذة عن طريقة الدفع</label>--}}
{{--                                                <input class="form-control" type="text" value="">--}}
{{--                                            </div>--}}
