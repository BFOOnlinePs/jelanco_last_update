...
{{--                        <a class="btn btn-warning d-block m-2">حالة الطلبات</a>--}}
                    ...
                    <div class="col border border-black ml-3">
                        <div class="border-top-0">
                            <div class="m-2">
                                <h4 class="text-center">قائمة الفواتير</h4>
                                <a href="" class="mb-2 btn btn-sm btn-primary">اضافة</a>
                                <div class="row">
                                    <div class="col">
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>مدفوعة</td>
                                                    <td>admin</td>
                                                    <td><a href="" class="btn btn-primary btn-sm">تفاصيل</a></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
...
{{--                                                <label for="">اسم الفاتورة</label>--}}
{{--                                                <input class="form-control" type="text" value="">--}}
{{--                                            </div>--}}
{{--                                            <div class="form-group">--}}
{{--                                                <label for="">نبذة عن الفاتورة</label>--}}
{{--                                                <input class="form-control" type="text" value="">--}}
{{--                                            </div>--}}
