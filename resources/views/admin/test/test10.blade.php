...
{{--                        <a class="btn btn-warning d-block m-2">حالة الطلبات</a>--}}
                    ...
                    <div class="col border border-black ml-3">
                        <div class="border-top-0">
                            <div class="m-2">
                                <h4 class="text-center">قائمة الاتفاقيات</h4>
                                <a href="" class="mb-2 btn btn-sm btn-primary">اضافة اتفاقية</a>
                                <div class="row">
                                    <div class="col">
...
{{--                                                <label for="">اسم الاتفاقية</label>--}}
{{--                                                <input class="form-control" type="text" value="">--}}
{{--                                            </div>--}}
{{--                                            <div class="form-group">--}}
{{--                                                <label for="">نبذة عن الاتفاقية</label>--}}
{{--                                                <input class="form-control" type="text" value="">--}}
{{--                                            </div>--}}
