...
@section('content')
    ...
    <a href="{{ route('users.secretarial.add') }}" class="btn btn-primary mb-2">اضافة سكرتيريا</a>
    <div class="card">
        <div class="card-header">
            <h3 class="text-center">قائمة السكرتيريا</h3>
        </div>
                            ...
                            <tbody>
                                @foreach($data as $key)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-success btn-sm" href="{{ route('users.secretarial.edit',['id'=>$key->id]) }}"><span class="fa fa-edit"></span></a>
                                            <a class="btn btn-dark btn-sm" href="{{ route('users.secretarial.details',['id'=>$key->id]) }}"><span class="fa fa-search"></span></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
