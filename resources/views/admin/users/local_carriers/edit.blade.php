...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('users.local_carriers.update',['id'=>$data->id]) }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <div>
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="row form-group">
                                                <div class="col">
                                                    ...
                                                    <input value="{{ old('user_phone1',$data->user_phone1) }}" placeholder="رقم الهاتف الاول" class="form-control"
                                                ...
                                                <div class="col">
                                                    ...
                                                    <input value="{{ old('user_phone2',$data->user_phone2) }}" placeholder="رقم الهاتف الثاني" class="form-control"
