...
@section('content')
    ...
    <div class="card">
        <div class="card-header text-center">
            <h5 class="text-bold">اضافة شركة نقل محلي</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('users.local_carriers.create') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input re value="{{ old('email') }}" name="email" placeholder="الايميل" class="form-control"
                                                       type="text">
                                                @error('email')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            ...
                                            <div class="row form-group">
                                                <div class="col">
                                                    ...
                                                    <input style="direction: ltr !important" value="{{ old('user_phone1') }}" placeholder="رقم الهاتف الاول" class="form-control"
