                            ...
                            <tbody>
                                @foreach($data as $key)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-success btn-sm" href="{{ route('users.procurement_officer.edit',['id'=>$key->id]) }}"><span class="fa fa-edit"></span></a>
                                            <a class="btn btn-dark btn-sm" href="{{ route('users.procurement_officer.details',['id'=>$key->id]) }}"><span class="fa fa-search"></span></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
