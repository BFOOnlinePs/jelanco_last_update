...
@section('content')
    ...
    <div class="card">
        <div class="card-header text-center">
            <h5 class="text-bold">اضافة موظف مشتريات</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('users.procurement_officer.create') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="row form-group">
                                                <div class="col">
                                                    ...
                                                    <input style="direction: ltr !important" value="{{ old('user_phone1') }}"
                                                ...
                                                <div class="col">
                                                    ...
                                                    <input style="direction: ltr !important" value="{{ old('user_phone2') }}"
                ...
                <button class="btn btn-success" style="width: 300px">حفظ</button>
            </form>
