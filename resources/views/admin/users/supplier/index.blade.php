...
@section('script')
    ...
    <script>
        ...
        function update_follow_by(user_id) {
            by_name = `#follow_by_${user_id}`
            follow_by = $(by_name).val();
            //follow_by = document.get;
            ...
            $.ajax({
                url: '{{ route('users.supplier.update_follow_by') }}',
                method: 'post',
                headers: headers,
                data: {
                    'user_id': user_id,
                ...
                success: function(data) {
                    console.log(data);
                    toastr.success('تم تعديل المتابعة بنجاح')
                },
                error: function(jqXHR, textStatus, errorThrown) {
                    alert('error');
                }
        ...
        function supplier_table() {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    'follow_by': document.getElementById('follow_by').value,
                    'potential_suppliers': document.getElementById('potential_suppliers').value,
                },
                success: function(data) {
                    $('#supplier_table').html(data.view);
                    loadScript("{{ asset('assets/plugins/select2/js/select2.full.min.js') }}", function() {
                        $(function() {
                            $('.select2bs4').select2({
                                theme: 'bootstrap4'
                            })
