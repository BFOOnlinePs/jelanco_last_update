            ...
            <form action="{{ route('users.supplier.create') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="row form-group">
                                                <div class="col">
                                                    ...
                                                    <input style="direction: ltr !important" required
                                                        value="{{ old('user_phone1') }}" placeholder="رقم الهاتف الاول"
                                                        class="form-control" name="user_phone1" type="text">
                                                    @error('user_phone1')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                                <div class="col">
                                                    ...
                                                    <input style="direction: ltr !important"
                                                        value="{{ old('user_phone2') }}" placeholder="رقم الهاتف الثاني"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <div
                                                    ...
                                                    <input name="potential_suppliers" type="checkbox" value="certified"
                                                        class="custom-control-input" id="customSwitch3"> <label
                                                        class="custom-control-label" for="customSwitch3">مورد معتمد \ غير
                                                        معتمد</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select multiple="multiple" class="form-control select2bs4"
                                                    name="user_category[]" id="">
                                        ...
                                        @if (auth()->user()->user_role == 1)
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select required class="form-control select2bs4" multiple="multiple"
                                                        name="follow_by[]" id="">
                        ...
                        <button type="submit" class="btn btn-success btn-block"><i class="fa-solid fa-floppy-disk"></i>
                            حفظ
                        </button>
                    </div>
                    {{--                    <div class="col-md-6"> --}}
