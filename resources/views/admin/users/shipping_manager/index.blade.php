...
@section('content')
    ...
    <a href="{{ route('users.shipping_manager.add') }}" class="btn btn-primary mb-2">اضافة مدير شحن</a>
    <div class="card">
        <div class="card-header">
            <h3 class="text-center">قائمة مدراء الشحن</h3>
        </div>
                            ...
                            <tbody>
                                @foreach($data as $key)
                                    <tr>
                                        <td>{{ $key->id }}</td>
                                        <td>{{ $key->name }}</td>
                                        <td style="direction: ltr !important;text-align:left;float:left">{{ $key->user_phone1 }}</td>
                                        <td>{{ $key->email }}</td>
                                        <td>
                                        ...
                                        <td>
                                            <a class="btn btn-success btn-sm" href="{{ route('users.shipping_manager.edit',['id'=>$key->id]) }}"><span class="fa fa-edit"></span></a>
                                            <a class="btn btn-dark btn-sm" href="{{ route('users.shipping_manager.details',['id'=>$key->id]) }}"><span class="fa fa-search"></span></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
