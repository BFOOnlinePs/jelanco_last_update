                        ...
                        <ul class="nav nav-tabs alert-info text-white" style="" id="custom-content-below-tab"
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-white" id="custom-content-below-profile-tab" data-toggle="pill"
                                   ...
                                   aria-controls="custom-content-below-profile" aria-selected="false">طلبات الشراء</a>
                            </li>
{{--                            <li class="nav-item">--}}
...
{{--                                            </div>--}}
                                        ...
                                        <div class="col-md-4 pt-5 text-center">
                                            ...
                                            <div>
                                                ...
                                                <hr>
                                                <p>يحتوي هذا القسم على المعلومات الاساسية لأمين المستودع</p>
                                                <a href="{{ route('users.storekeeper.edit',['id'=>$data->id]) }}" class="btn btn-info">تعديل بيانات أمين المستودع</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
