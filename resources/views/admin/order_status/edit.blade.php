...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="text-center">تعديل حالة الطلبية</h3>
        </div>
        <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="name" value="{{ $data->name }}" type="text" placeholder="حالة الطلبية">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="">لون حالة الطلبية</label>
                            <input class="form-control" name="status_color" value="{{ $data->status_color }}" type="color" placeholder="لون حالة الطلبية">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="">لون الخط</label>
                            <input class="form-control" name="status_text_color" value="{{ $data->status_text_color }}" type="color" placeholder="لون الخط">
                        </div>
                    </div>
                </div>
                <button class="btn btn-success"><span class="fa fa-save"></span> حفظ التغييرات</button>
            </form>
        </div>
    </div>
