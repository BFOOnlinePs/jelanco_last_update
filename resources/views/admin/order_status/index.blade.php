...
@endsection
@section('content')
    <div class="modal fade" id="modal-add-order_status">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">اضافة حالة للطلبية</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{ route('order_status.create') }}" method="post" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control" placeholder="حالة الطلبية">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="">لون الحالة</label>
                                    <input type="color" name="status_color" class="form-control" placeholder="لون الحالة">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="">لون الخط</label>
                                    <input type="color" name="status_text_color" class="form-control" placeholder="لون الخط">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="mb-2">
        <button type="button" class="btn btn-dark" data-toggle="modal" data-target="#modal-add-order_status">
            <span class="fa fa-plus"></span> اضافة حالة للطلبية
        </button>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-header">
            <h3 class="text-center">حالة الطلبيات</h3>
        </div>
                ...
                <table class="table table-hover table-bordered">
                    ...
                    @else
                        @foreach($data as $key)
                            <tr>
                                <td>{{ $key->name }}</td>
                                <td class="text-center" width="100" style="background-color: {{ $key->status_color }};color: {{ $key->status_text_color }}">
                                    {{ $key->status_color }}
                                </td>
                                <td>
                                    <a href="{{ route('order_status.edit',['id'=>$key->id]) }}" class="btn btn-success btn-sm"><span class="fa fa-edit"></span></a>
                                </td>
                            </tr>
                        @endforeach
                    @endif
