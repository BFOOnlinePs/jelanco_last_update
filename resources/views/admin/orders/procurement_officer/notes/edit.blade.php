...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-header">
            <h3 class="text-center">تعديل ملاحظة</h3>
        </div>

        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ route('procurement_officer.orders.notes.update_order_notes',['id'=>$data->id]) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="">نص الملاحظة</label>
                                    <textarea class="form-control" name="note_text" id="" cols="30" rows="4" placeholder="يرجى كتابة الملاحظة">{{ $data->note_text }}</textarea>
                                </div>
                                <div class="col-md-12">
                                    <input class="form-control text-center" name="alert_date" type="date" value="{{ $data->alert_date }}">
                                </div>
                            </div>
                        </div>
