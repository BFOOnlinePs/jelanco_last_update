...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="nav nav-tabs" id="custom-content-above-tab" role="tablist">
                    <li
                        class="nav-item @if (session('tab_id') == null) active @endif  @if (\Illuminate\Support\Facades\Session::has('tab_id')) @if (session('tab_id') == 1)  active @endif @endif ">
                        <a class="nav-link" id="product-tab" data-toggle="pill" href="#product" role="tab"
                            aria-controls="product" aria-selected="true">الأصناف</a>
                    </li>
                    <li
                        class="nav-item @if (\Illuminate\Support\Facades\Session::has('tab_id')) @if (session('tab_id') == 2)  active @endif @endif">
                    ...
                    <li
                        class="nav-item @if (\Illuminate\Support\Facades\Session::has('tab_id')) @if (session('tab_id') == 3)  active @endif @endif">
                        <a class="nav-link" id="anchor-tab" data-toggle="pill" href="#anchor" role="tab"
                            aria-controls="anchor"
                            aria-selected="@if (\Illuminate\Support\Facades\Session::has('tab_id')) @if (session('tab_id') == 2) true @else false @endif @endif">ترسية</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="financial-file-tab" data-toggle="pill" href="#financial-file"
                            role="tab" aria-controls="financial-file" aria-selected="">الملف المالي</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="insurance-tab" data-toggle="pill" href="#insurance" role="tab"
                            aria-controls="insurance" aria-selected="false">تأمين</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if (\Illuminate\Support\Facades\Session::has('tab_id')) @if (session('tab_id') == 9) active @endif @endif"
                            id="attachment-tab" data-toggle="pill" href="#attachment" role="tab"
                            aria-controls="attachment"
                            aria-selected="@if (\Illuminate\Support\Facades\Session::has('tab_id')) @if (session('tab_id') == 9) true @else false @endif @endif">مرفقات</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link @if (\Illuminate\Support\Facades\Session::has('tab_id')) @if (session('tab_id') == 10)  active @endif @endif"
                ...
                <div class="tab-content" id="custom-content-above-tabContent">
                                            ...
                                            @else
                                                @foreach ($data as $key)
                                                    <tr id="delete_tr_{{ $loop->index }}">
                                                        ...
                                                        <td>
                                                            <input
                                                                onchange="updateQty( this.value  , {{ $key->id }})"
                                                        ...
                                                        <td>
                                                            <select
                                                                onchange="updateUnit(this.value  , {{ $key->id }})"
                                                                name="product_id"
                                                                class="form-control select2bs4 select2-hidden-accessible"
                                                                style="width: 80%;"
                                                                data-select2-id="{{ $loop->index }}" tabindex="-1"
                                                                aria-hidden="true">
                                                                @foreach ($unit as $unit_key)
                                                                    <option
                                                                        @if (old('unit_id', $key->unit_id) == $unit_key->id) selected @endif
                                                                        value="{{ $unit_key->id }}">
                                                                        {{ $unit_key->unit_name }}</option>
                                                                @endforeach
                                                            </select>
                                                        </td>
                                                        <td>
                    ...
                    <div class="tab-pane fade @if (\Illuminate\Support\Facades\Session::has('tab_id')) @if (session('tab_id') == 2) show active @endif @endif"
                    ...
                    <div class="tab-pane fade @if (\Illuminate\Support\Facades\Session::has('tab_id')) @if (session('tab_id') == 3) show active @endif @endif"
                        id="anchor" role="tabpanel" aria-labelledby="anchor-tab">
                        <div class="p-2">
                            <div class="form-group">
                                <form action="{{ route('procurement_officer.orders.anchor.create_anchor') }}"
                                    method="post">
                                    @csrf
                    ...
                    <div class="tab-pane fade" id="financial-file" role="tabpanel" aria-labelledby="financial-file">
                        قريبا ..
                    </div>
                    ...
                    <div class="tab-pane fade @if (\Illuminate\Support\Facades\Session::has('tab_id')) @if (session('tab_id') == 9) show active @endif @endif"
                        id="attachment" role="tabpanel" aria-labelledby="attachment-tab">
                        <div class="p-2">
                            <button type="button" class="btn btn-dark mb-2" data-toggle="modal"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-danger btn-sm"
                                                        onclick="return confirm('هل تريد حذف البيانات ؟؟')"
                                                        href="{{ route('order_items.delete_order_attachment', ['id' => $key->id]) }}">حذف</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                    ...
                    <div class="tab-pane fade @if (\Illuminate\Support\Facades\Session::has('tab_id')) @if (session('tab_id') == 10) show active @endif @endif"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-success btn-sm"
                                                        href="{{ route('order_items.edit_order_notes', ['order_id' => $key->id]) }}">تعديل</a>
                                                    <a class="btn btn-danger btn-sm"
                                                        onclick="return confirm('هل تريد حذف البيانات ؟؟')"
                                                        href="{{ route('order_items.delete_order_notes', ['order_id' => $key->id]) }}">حذف</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="product" onchange="selectedUnit(this.value)" required
                                            ...
                                            @foreach ($product as $key)
                                                <option value="{{ $key->id }}">{{ $key->product_name_ar }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
        ...
        <div class="modal fade" id="modal-lg-offer_price">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <form action="{{ route('procurement_officer.orders.price_offer.create_price_offer') }}"
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" name="note_text" id="" cols="30" rows="4"
