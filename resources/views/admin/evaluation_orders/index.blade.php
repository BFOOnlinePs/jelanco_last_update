...
{{--            </div>--}}
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="">المورد</label>
                        <select onchange="orders_list()" class="select2bs4 form-control supplier_select2"
                                name="supplier_id" id="supplier_id">
                            <option value="">جميع الموردين</option>
                            @foreach ($supplier as $key)
                                <option value="{{ $key->id }}">{{ $key->name }}</option>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="">متابعة بواسطة</label>
                        <select onchange="orders_list()" class="select2bs4 form-control supplier_select2" name="to_user"
                                id="to_user">
                            <option value="">جميع المستخدمين</option>
                            @foreach ($users as $key)
                                <option value="{{ $key->id }}">{{ $key->name }}</option>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="">حالة الطلبية</label>
                        <select onchange="orders_list()" class="form-control" name="order_status" id="order_status">
                            <option value="">جميع الحالات</option>
                            @foreach ($order_status as $key)
                                @if ($key->id != 10)
                                    <option value="{{ $key->id }}">{{ $key->name }}</option>
