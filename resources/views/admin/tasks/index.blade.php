        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">اسناد مهمة</h4>
                ...
                <form action="{{ route('tasks.create') }}" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input required type="text" name="title" class="form-control" placeholder="ادخل العنوان">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="">الملاحظات</label>
                                    <textarea name="description" class="form-control" placeholder="ادخل الملاحظات" id=""
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="">تاريخ بداية المهمة</label>
                                    <input required name="start_date" class="form-control date_format" type="text">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="">ادخل بداية الوقت</label>
                                    <input required name="start_time" class="form-control" type="time">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select required class="form-control" name="duration_unit" id="">
                                        <option value="day">يوم</option>
                                        <option value="houre">ساعة</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select required class="form-control" name="task_type" id="">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-sm">
                    ...
                    @foreach($data as $key)
                        <tr>
                            <td>{{ $key['from_user']->name }}</td>
                            <td>{{ $key['to_user']->name }}</td>
                            <td>{{ $key->title }}</td>
                            <td>{{ $key->description }}</td>
                            <td>{{ $key->start_date }}</td>
                            <td>{{ $key->start_time }}</td>
                            <td>{{ $key->duration }}</td>
                            <td>{{ $key->duration_unit }}</td>
                            <td>{{ $key->task_status }}</td>
                            <td>{{ $key['task_type']->type_name }}</td>
                            <td>
                                <a class="btn btn-success btn-sm"
                                   href="{{ route('tasks.edit',['id'=>$key->id]) }}"><span
